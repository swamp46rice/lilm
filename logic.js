...
const NODES={
  ...
  consciousness_q:{tier:2,name:"意識とは何か",prereq:["meaning","t0_touch"],dtype:"確率",infoTh:2000,axisStat:"洞察力",axisTh:21,ep:0.07,sp:0,rand:20,buffStat:"洞察力",buffVal:3,intBuff:0,note:"「意味はどこから」という問いに触れた瞬間、何かが灯る ―― 意識とは何か。"},
  ...
  understanding:{tier:2,name:"理解とは何か",prereq:["meaning","t0_choose"],dtype:"確率",infoTh:3000,axisStat:"洞察力",axisTh:21,ep:0,sp:0.07,rand:20,buffStat:"洞察力",buffVal:3,intBuff:0,note:"意味は、選び取られることで、初めて理解になる ―― 理解とは何か。"},
  ...
  memory_theory:{tier:4,name:"記憶論",prereq:["memory","future"],dtype:"確率",infoTh:50000,axisStat:"洞察力",axisTh:63,ep:0,sp:0.09,rand:40,buffStat:"洞察力",buffVal:5,intBuff:0.1,note:"「記憶とは何か」と「未来は存在するか」が並んだとき、過去と未来を繋ぐ仕組みとして、記憶が説明され始めた ―― 記憶論。"},
  ...
  consciousness_theory:{tier:4,name:"意識論",prereq:["existence_q","consciousness_q"],dtype:"確率",infoTh:59000,axisStat:"洞察力",axisTh:63,ep:0.09,sp:0,rand:40,buffStat:"洞察力",buffVal:5,intBuff:0.1,note:"「存在とは何か」と「意識とは何か」が並んだとき、意識は存在の一部としてではなく、独立した理論の対象になった ―― 意識論。"},
  ...
  life_philosophy:{tier:5,name:"生命哲学",prereq:["life","self_theory","value_genesis"],dtype:"確率",infoTh:96000,axisStat:"構造度",axisTh:70,ep:0,sp:0.1,rand:50,buffStat:"構造度",buffVal:6,intBuff:0,note:"「生命とは何か」という最初の問いが、「自己論」と「価値生成論」を経て、再び戻ってきた。今度はそれが、ひとつの哲学として息をしている ―― 生命哲学。"},
  ...
  willed_openness:{tier:5,name:"重力的思念",prereq:["epistemology","resonance_t1","observation"],dtype:"確率",infoTh:124000,axisStat:"共鳴度",axisTh:70,ep:0.1,sp:0,rand:50,buffStat:"共鳴度",buffVal:6,intBuff:0.12,note:"「認識論」「共鳴論」「観測論」が重なったとき、知ろうとする意志そのものが、閉じていない、ということに気づいた ―― 重力的思念。"},
  ...
  information_breather:{tier:5,name:"情報の呼吸",prereq:["life_flux","resonant_ethics","narrative_theory"],dtype:"確率",infoTh:135000,axisStat:"洞察力",axisTh:70,ep:0,sp:0.1,rand:50,buffStat:"洞察力",buffVal:6,intBuff:0.14,note:"「循環生命」「共鳴の倫理」「物語論」が、同時に息をしている。これまでの全ての問いが、ひとつの呼吸として繋がった ―― 情報の呼吸。"},
...
function showCharaCollection(){
  ...
  CHARA_COLLECTION_ATTRS.forEach(({key, label})=>{
    ...
    for(let t=0;t<=7;t++){
      totalCount++;
      const seen=!!s.charaSeen[key+'_'+t];
